...
class UNet3D(BaseModel):
    ...
    def __init__(self, in_channels, n_classes, base_n_filter=1):
    ...
    def forward(self, x):
        ...
        #if context_4.shape[4] % 2 == 1:
        #    out = out[..., :out.shape[4]-1]
        ...
        #if ds1_ds2_sum_upscale.shape[4] != ds3_1x1_conv.shape[4]:
        #    ds1_ds2_sum_upscale = ds1_ds2_sum_upscale[..., ds1_ds2_sum_upscale.shape[4]-1]

        ds1_ds2_sum_upscale_ds3_sum = ds1_ds2_sum_upscale + ds3_1x1_conv
        ds1_ds2_sum_upscale_ds3_sum_upscale = self.upsacle(ds1_ds2_sum_upscale_ds3_sum)

        if out_pred.shape[4] %2 == 1:
            a,b,c,d,e = ds1_ds2_sum_upscale_ds3_sum_upscale.shape
            #t = torch.zeros([a,b,c,d,e])
            #ds1_ds2_sum_upscale_ds3_sum_upscale = torch.cat([t, ds1_ds2_sum_upscale_ds3_sum_upscale], dim = 4)
            ds1_ds2_sum_upscale_ds3_sum_upscale = ds1_ds2_sum_upscale_ds3_sum_upscale[..., :e-1]

        out = out_pred + ds1_ds2_sum_upscale_ds3_sum_upscale
        seg_layer = out
        #print("seg_layer", seg_layer.shape)
        return seg_layer
